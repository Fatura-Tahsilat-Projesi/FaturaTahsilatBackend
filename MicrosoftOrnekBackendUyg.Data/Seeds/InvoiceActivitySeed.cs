    ...
    class InvoiceActivitySeed:IEntityTypeConfiguration<InvoiceActivity>
    {
        ...
        public void Configure(EntityTypeBuilder<InvoiceActivity> builder)
        {
            builder.HasData(
                ...
                new InvoiceActivity { Id = 4, UserId = 3, InvoiceId = 4, CompanyId = 4, TransactionDate = DateTime.ParseExact("04/09/2021 14:05:00", "dd/MM/yyyy HH:mm:ss", null), StatusCode = 3 },
                new InvoiceActivity { Id = 5, UserId = 2, InvoiceId = 5, CompanyId = 5, TransactionDate = DateTime.ParseExact("05/09/2021 15:25:00", "dd/MM/yyyy HH:mm:ss", null), StatusCode = 50 },
                new InvoiceActivity { Id = 6, UserId = 1, InvoiceId = 6, CompanyId = 6, TransactionDate = DateTime.ParseExact("06/09/2021 16:05:00", "dd/MM/yyyy HH:mm:ss", null), StatusCode = -1 }
                );
        }
    }
}
